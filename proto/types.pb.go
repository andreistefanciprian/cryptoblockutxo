...
type Header struct {
	...
	Height        int32                  `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`       // Block height/number
	PrevHash      []byte                 `protobuf:"bytes,3,opt,name=prevHash,proto3" json:"prevHash,omitempty"`    // Previous block hash
	RootHash      []byte                 `protobuf:"bytes,4,opt,name=rootHash,proto3" json:"rootHash,omitempty"`    // Merkle root hash
	Timestamp     int64                  `protobuf:"varint,5,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Block creation timestamp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TxInput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PrevTxHash    []byte                 `protobuf:"bytes,1,opt,name=prevTxHash,proto3" json:"prevTxHash,omitempty"`      // Hash of the previous transaction
	PrevOutIndex  uint32                 `protobuf:"varint,2,opt,name=prevOutIndex,proto3" json:"prevOutIndex,omitempty"` // Index of the output in the previous transaction
	PublicKey     []byte                 `protobuf:"bytes,3,opt,name=publicKey,proto3" json:"publicKey,omitempty"`        // Public key to unlock the output
	Signature     []byte                 `protobuf:"bytes,4,opt,name=signature,proto3" json:"signature,omitempty"`        // Signature to unlock the output
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TxOutput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Amount        int64                  `protobuf:"varint,1,opt,name=amount,proto3" json:"amount,omitempty"`  // Amount in smallest currency unit (e.g., satoshis)
	Address       []byte                 `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"` // Hash of the recipient's public key
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Transaction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Version       int32                  `protobuf:"varint,1,opt,name=version,proto3" json:"version,omitempty"` // Transaction version
	Inputs        []*TxInput             `protobuf:"bytes,2,rep,name=inputs,proto3" json:"inputs,omitempty"`    // Transaction inputs
	Outputs       []*TxOutput            `protobuf:"bytes,3,rep,name=outputs,proto3" json:"outputs,omitempty"`  // Transaction outputs
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_types_proto_rawDesc = "" +
	...
	"\aoutputs\x18\x03 \x03(\v2\t.TxOutputR\aoutputsB6Z4github.com/andreistefanciprian/cryptoblockutxo/protob\x06proto3"
